...
LinkedList* ll_filterAndAdd(LinkedList* this, int (*pFunc)(void*,char*),char* nombre)
{
...
int ll_reduceIntDual(LinkedList* this, int (*pFunc)(void*,int),int id)
{
	int returnAux =-1;
	int len = ll_len(this);
	int aux=0;
