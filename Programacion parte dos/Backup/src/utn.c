...
int menu()
{
	...
	printf("2) Vender afiches\n");
	printf("3) Modificar venta\n");
	printf("4) Cobrar venta\n");
	printf("5) Generar informe de cobros\n");
	printf("6) Generar informe de deudas\n");
	printf("7) Generar estadísticas\n");
	printf("8) Mostrar listas\n");
	printf("9) Salir\n");

    utn_getInt("\nIngrese opcion: ", "Ingrese una opcion entre 1 y 10", &opcion, 1, 9, 1);
